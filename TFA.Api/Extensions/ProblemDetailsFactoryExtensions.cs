...
public static class ProblemDetailsFactoryExtensions
{
    public static ProblemDetails CreateFrom(this ProblemDetailsFactory factory, HttpContext httpContext, IntentionManagerException intentionManagerException) => 
        factory.CreateProblemDetails(httpContext, StatusCodes.Status403Forbidden, "Authorization failed", intentionManagerException.Message);
    ...
    public static ProblemDetails CreateFrom(this ProblemDetailsFactory factory, HttpContext httpContext, DomainException domainException) => 
        factory.CreateProblemDetails(httpContext, StatusCodes.Status403Forbidden, "Domain exception", domainException.Message);   
    ...
    public static ProblemDetails CreateFrom(this ProblemDetailsFactory factory, HttpContext httpContext, ValidationException validationException)
    {
        ...
        return factory.CreateValidationProblemDetails(httpContext, modelState4Dictionary,StatusCodes.Status403Forbidden, "Validation error",
