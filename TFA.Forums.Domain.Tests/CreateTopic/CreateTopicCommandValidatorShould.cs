...
using TFA.Forums.Domain.Validations.Commands.CreateTopic;
...
public class CreateTopicCommandValidatorShould
{
    ...
    public static IEnumerable<object[]> GetInvalidCommand()
    {
        ...
        [
            ...
            {
                Title =
                "NuncconsecteturNuncconsecteturNuncconsecteturNuncconsecteturNunteturonsecteturNuncconsecteturNuncconsectetur"
            },
    ...
    public void ReturnFailure_WneCommandIsInvalid(CreateTopicCommand command, string expectedInvalidPropertName,
