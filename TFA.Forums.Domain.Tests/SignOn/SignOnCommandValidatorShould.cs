...
using TFA.Forums.Domain.Validations.Authentications.SignOn;

namespace TFA.Forums.Domain.Tests.SignOn;
...
public class SignOnCommandValidatorShould
{
    ...
    public static IEnumerable<object[]> GetInvalidCommand()
    {
        ...
        [
            ...
            {
                Login =
                "de67f907-c96b-4bd2-888d-b4be34fdff1af1c00f9b-03ff-46fa-8c5e-7b64a9378c123ee388e3-faf9-4007-b2fe-6ed8bfb4cf32"
            }
        ];
